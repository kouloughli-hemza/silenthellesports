...
function PlaneSVG() {
  return (
    <svg width="200" height="60" viewBox="0 0 200 60" aria-hidden>
      <defs>
        <linearGradient id="hpd-plane-grad" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#2a2a2a" />
          <stop offset="50%" stopColor="#1a1a1a" />
          <stop offset="100%" stopColor="#0a0a0a" />
        </linearGradient>
        <linearGradient id="hpd-plane-light" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="rgba(230,0,19,0.15)" />
          <stop offset="100%" stopColor="rgba(230,0,19,0)" />
        </linearGradient>
      </defs>
      <ellipse cx="100" cy="32" rx="92" ry="9" fill="url(#hpd-plane-grad)" />
      <ellipse cx="100" cy="30" rx="92" ry="7" fill="url(#hpd-plane-light)" />
      <path d="M170 28 Q180 22 188 26 L192 32 L170 32 Z" fill="#0a0a0a" />
      <path d="M16 28 L4 8 L18 12 L26 28 Z" fill="#1a1a1a" />
      <path d="M14 32 L0 38 L18 34 Z" fill="#1a1a1a" />
      <path d="M14 32 L0 26 L18 30 Z" fill="#1a1a1a" />
      <path d="M70 24 Q90 8 110 8 L120 8 Q108 22 92 26 Z" fill="#1a1a1a" />
      <path d="M70 38 Q90 54 110 54 L120 54 Q108 40 92 36 Z" fill="#0a0a0a" />
      <ellipse cx="86" cy="18" rx="6" ry="3" fill="#2a2a2a" />
      <ellipse cx="86" cy="46" rx="6" ry="3" fill="#1a1a1a" />
      <circle cx="78" cy="18" r="1.5" fill="#FF4500" opacity="0.9" />
      <circle cx="78" cy="46" r="1.5" fill="#FF4500" opacity="0.7" />
      <ellipse cx="76" cy="18" rx="3" ry="6" fill="rgba(255,69,0,0.15)" />
      <ellipse cx="76" cy="46" rx="3" ry="6" fill="rgba(255,69,0,0.1)" />
      <rect x="40" y="28" width="120" height="2" fill="#1a0408" />
      <ellipse cx="100" cy="40" rx="60" ry="2" fill="rgba(255,69,0,0.2)" />
      <path d="M16 32 L24 36 L34 36 L26 32 Z" fill="#0a0204" />
    </svg>
  );
}
...
function TrooperSVG({ chuteRef }: { chuteRef: React.RefObject<SVGGElement | null> }) {
  return (
    <svg width="64" height="90" viewBox="0 0 64 90" aria-hidden>
      <defs>
        <radialGradient id="hpd-chute" cx="0.5" cy="0.7">
          <stop offset="0%" stopColor="#FF4500" />
          <stop offset="50%" stopColor="#E60013" />
          <stop offset="100%" stopColor="#8a0010" />
        </radialGradient>
      </defs>
      <g ref={chuteRef} style={{ transformOrigin: "50% 100%" }}>
        <path d="M2 36 Q32 -4 62 36 L58 36 L52 24 L46 36 L40 24 L32 36 L24 24 L18 36 L12 24 L6 36 L2 36 Z" fill="url(#hpd-chute)" stroke="#5a000c" strokeWidth="0.5" />
        <path d="M32 4 L32 36" stroke="#8a0010" strokeWidth="0.4" opacity="0.6" />
        <path d="M14 8 Q20 22 24 36" stroke="#8a0010" strokeWidth="0.4" opacity="0.6" fill="none" />
        <path d="M50 8 Q44 22 40 36" stroke="#8a0010" strokeWidth="0.4" opacity="0.6" fill="none" />
        <path d="M2 36 Q32 -4 62 36" stroke="rgba(255,217,61,0.3)" strokeWidth="0.5" fill="none" />
      </g>
      <line x1="6" y1="36" x2="28" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <line x1="14" y1="36" x2="30" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <line x1="22" y1="36" x2="31" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <line x1="32" y1="36" x2="32" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <line x1="42" y1="36" x2="33" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <line x1="50" y1="36" x2="34" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <line x1="58" y1="36" x2="36" y2="62" stroke="#1a1a1a" strokeWidth="0.5" />
      <ellipse cx="32" cy="68" rx="5" ry="3" fill="#1a1a1a" />
      <ellipse cx="32" cy="74" rx="6" ry="7" fill="#0a0a0a" />
      <line x1="28" y1="78" x2="25" y2="86" stroke="#0a0a0a" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="36" y1="78" x2="39" y2="86" stroke="#0a0a0a" strokeWidth="2.5" strokeLinecap="round" />
      <rect x="29" y="72" width="6" height="4" fill="#E60013" />
    </svg>
  );
}
